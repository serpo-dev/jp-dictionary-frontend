...
const Example = (props) => {
    ...
    const change = (event) => {
        ...
        console.log([elemValue, elemType, num]);
    ...
    return (
        <div className="flex flex-col space-y-4 bg-rose-200 rounded-md p-4">
            <div className="flex flex-row justify-center h-10">
                <h2>Example {Number(props.num) + 1}</h2>
            ...
            <div className="flex items-center justify-start space-x-4 text-bold break-normal min-h-fit">
                <label
                    for={`${stylesheet}_EXAMPLES_2`}
                    className="basis-1/4 w-full text-sm cursor-pointer font-bold"
                >
                    Furigana:
                </label>
                <input
                    id={`${stylesheet}_EXAMPLES_2`}
                    onChange={change}
            ...
            <div className="flex items-center justify-start space-x-4 text-bold break-normal min-h-fit">
                <label
                    for={`${stylesheet}_EXAMPLES_3`}
                    className="basis-1/4 w-full text-sm cursor-pointer font-bold"
                >
                    English:
                </label>
                <input
                    id={`${stylesheet}_EXAMPLES_3`}
                    onChange={change}
                    value={enText}
                    type="text"
                    className="basis-3/4 w-full pl-2 pr-2 font-semibold self-end text-center rounded-lg bg-rose-50 h-8"
            ...
            <div className="flex items-center justify-start space-x-4 text-bold break-normal min-h-fit">
                <label
                    for={`${stylesheet}_EXAMPLES_4`}
                    className="basis-1/4 w-full text-sm cursor-pointer font-bold"
                >
                    Russian:
                </label>
                <input
                    id={`${stylesheet}_EXAMPLES_4`}
                    onChange={change}
                    value={ruText}
                    type="text"
                    className="basis-3/4 w-full pl-2 pr-2 font-semibold self-end text-center rounded-lg bg-rose-50 h-8"
