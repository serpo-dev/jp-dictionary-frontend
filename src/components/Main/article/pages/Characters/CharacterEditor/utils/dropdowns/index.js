...
const Dropdown = (props) => {
    ...
    useEffect(() => {
        const isLastField =
            ...
            (props.lastField === "ASSOCIATIONS" &&
                dropdownType === "associations") ||
            (props.lastField === "TRANSLATIONS" &&
                dropdownType === "translations") ||
            (props.lastField === "EXAMPLES" && dropdownType === "examples") ||
            (props.lastField === "ASSOCIATIONS_NEW_ONE" &&
                dropdownType === "associations") ||
            (props.lastField === "TRANSLATIONS_NEW_ONE" &&
                dropdownType === "translations") ||
            (props.lastField === "EXAMPLES_NEW_ONE" &&
                dropdownType === "examples") ||
            (props.lastField === "TRANSLATIONS_DELETE_ONE" &&
                dropdownType === "translations") ||
            (props.lastField === "EXAMPLES_DELETE_ONE" &&
                dropdownType === "examples");
    ...
    return (
        <div>
            <div className="flex flex-row items-center space-x-4 h-14">
                <h2>
                    ...
                    >
                        <div className="flex flex-row">
                            ...
                            <h2 className="text-xl font-bold p-0 -mt-2 ml-2">
                                {dropdownType}
                            </h2>
                        </div>
                    </label>
                ...
                <div
                    onClick={add}
                    className="flex flex-col justify-center hover:scale-110 active:bg-rose-100 hover:bg-rose-500 transition ease-in-out duration-200 bg-rose-400 h-8 w-8 rounded-full text-center font-black text-2xl text-rose-900 cursor-pointer"
                >
                    <p className="-mt-1">+</p>
                </div>
            </div>
