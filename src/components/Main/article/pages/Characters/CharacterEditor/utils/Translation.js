...
const Translation = (props) => {
    let jpNormalText = props.data.jpNormalText || "";
    let jpFuriganaText = props.data.jpFuriganaText || "";
    let enText = props.data.enText || "";
    let ruText = props.data.ruText || "";
    ...
    const deleting = async () => {
        await updateCharacterActionCreator([
            null,
            "TRANSLATIONS_DELETE_ONE",
            num,
        ]);
    };
    ...
    return (
        <div className="flex flex-col space-y-4 bg-rose-200 rounded-md p-4">
            <div className="flex flex-row justify-center h-10">
                <h2>Translation {Number(props.num) + 1}</h2>
            ...
            <div className="flex items-center justify-start space-x-4 text-bold break-normal min-h-fit">
                <label
                    for={`${stylesheet}_TRANSLATIONS_1`}
                    className="basis-1/4 w-full text-sm cursor-pointer font-bold"
                >
                    Normal:
                </label>
                <input
                    id={`${stylesheet}_TRANSLATIONS_1`}
                    onChange={change}
                    value={jpNormalText}
                    type="text"
                    className="basis-3/4 w-full pl-2 pr-2 font-semibold self-end text-center rounded-lg bg-rose-50 h-8"
                />
            </div>
            <div className="flex items-center justify-start space-x-4 text-bold break-normal min-h-fit">
                <label
                    for={`${stylesheet}_TRANSLATIONS_2`}
                    className="basis-1/4 w-full text-sm cursor-pointer font-bold"
                >
                    Furigana:
                </label>
                <input
                    id={`${stylesheet}_TRANSLATIONS_2`}
                    onChange={change}
                    value={jpFuriganaText}
                    type="text"
                    className="basis-3/4 w-full pl-2 pr-2 font-semibold self-end text-center rounded-lg bg-rose-50 h-8"
                />
            </div>
            <div className="flex items-center justify-start space-x-4 text-bold break-normal min-h-fit">
                <label
                    for={`${stylesheet}_TRANSLATIONS_3`}
                    className="basis-1/4 w-full text-sm cursor-pointer font-bold"
                >
                    English:
                </label>
                <input
                    id={`${stylesheet}_TRANSLATIONS_3`}
                    onChange={change}
                    value={enText}
                    type="text"
                    className="basis-3/4 w-full pl-2 pr-2 font-semibold self-end text-center rounded-lg bg-rose-50 h-8"
            ...
            <div className="flex items-center justify-start space-x-4 text-bold break-normal min-h-fit">
                <label
                    for={`${stylesheet}_TRANSLATIONS_4`}
                    className="basis-1/4 w-full text-sm cursor-pointer font-bold"
                >
                    Russian:
                </label>
                <input
                    id={`${stylesheet}_TRANSLATIONS_4`}
                    onChange={change}
                    value={ruText}
                    type="text"
                    className="basis-3/4 w-full pl-2 pr-2 font-semibold self-end text-center rounded-lg bg-rose-50 h-8"
