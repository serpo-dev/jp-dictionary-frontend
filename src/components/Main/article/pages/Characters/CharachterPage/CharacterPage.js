...
const CharacterPage = (props) => {
  ...
  let rectLeft = document.getElementById("dynamic_bg_article")
    ? document.getElementById("dynamic_bg_article").getBoundingClientRect()
        .left -
      16 +
      "px"
    : "0px";
    ...
    <div id="dynamic_bg_article">
      <div className="grid grid-cols-12 -m-4">
        <div className="col-span-12">
          <div className="flex flex-col">
            ...
            <div
              ...
              style={{
                backgroundImage: `url(${mnemoImg ? mnemoImg : defaultImg})`,
        ...
        <div className="flex flex-col col-span-4 ml-8 mr-0 mb-4 -mt-16">
          <span>
            <p className="text-center font-bold text-xl mb-4">犭 • 艹 • 田</p>
            <p className="text-center text-sm m-2 font-semibold">{mnemoDisc}</p>
          </span>
        </div>
