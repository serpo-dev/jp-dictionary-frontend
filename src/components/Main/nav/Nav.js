    ...
    <span>
      ...
      >
        ...
        <div className="flex flex-col w-[145px] gap-2">
          <NavLink
            to="/home"
            className="transition duration-100 ease-out grid grid-cols-12 hover:bg-pink-50 hover:drop-shadow content-center h-8 bg-rose-50/90 rounded-lg w-full"
          >
          ...
          <NavLink
            to="/questions"
            className="transition duration-100 ease-out grid grid-cols-12 hover:bg-pink-50 content-center h-8 bg-rose-50/90 rounded-lg w-full"
          >
            <div className="col-span-3 justify-self-center">
