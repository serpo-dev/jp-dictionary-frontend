          ...
          <div className="flex flex-row">
            <div className="ml-[5%]">
              <NavLink to="/">
                <img
                  src={headerLogo}
                  className={`${stylesheet.headerImg} h-14`}
                />
              </NavLink>
            </div>
            <div className="pl-3.5 pt-2.5">
              <NavLink to="/">
                <p className="transition duration-100 w-fit ease-out hover:ease-in hover:text-rose-500 font-bold text-2xl text-slate-800">
                  JPot
                </p>
              </NavLink>
            </div>
