...
const Start = (props) => {
  const canvas = function () {
    ...
    var matrix =
      "ああ、そんな世界があるなら、俺達は、生まれる世界を間違えたわけだ";
    ...
    <div className={stylesheet.body}>
      <div className="flex flex-col">
        <div className="h-0 z-20">
          <div
            className="h-screen w-screen bg-gradient-to-b from-slate-50/0 via-stone-900/80 to-stone-900
        ...
        <div className="flex flex-col h-screen w-screen z-20">
          ...
          >
            <div
              className="flex flex-rows space-x-10 mt-10
                            lg:mr-[10vw]
                        "
            >
              <NavLink
                to="/auth"
                className="flex flex-col justify-center bg-gradient-to-r from-pink-500 to-rose-500 h-14 pl-6 pr-6 font-bold text-2xl rounded-full text-slate-900 shadow-lg hover:text-rose-100 hover:bg-rose-700 hover:scale-110 transition ease-in-out duration-300"
              >
          ...
          <footbar className="h-14">
            ...
            >
              ...
              <a
                ...
                className="hover:text-rose-600 transition ease-in-out duration-300"
              >
                yphwd
              </a>
            </p>
